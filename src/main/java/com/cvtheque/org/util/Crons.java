...
public class Crons {
	...
	// Statistiques : UPDATE le nombre des Candidats liés et des Opportunités liées à une Technologie : chaque 30 minutes
	...
	// Statistiques : UPDATE le nombre des Candidats liés et des Partenaires liés à une Entreprise : chaque 30 minutes
	@Scheduled(fixedRate = 1800000)
